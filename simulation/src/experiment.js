...
function changeprocExperiment(scope) {
  ...
  getChild("current_display").visible =
    getChild("voltage_display").visible =
    getChild("gaussmeter_display").visible =
      false;
  scope.current_disable =
    scope.thickness_disable =
    scope.hallcurrent_disable =
    scope.showvoltage_disable =
      false;
  twistedwire_moveflag =
    twistedwire_insertflag =
    move_flag =
    probeFlag =
    whiteprobe_moveflag =
      false;
  getChild("twisted_wire").visible =
    getChild("twisted_wire_move").visible =
    getChild("twisted_wire_connected").visible =
      false;
  getChild("big_arrow_left").mouseEnabled = getChild(
    "big_arrow_right",
  ).mouseEnabled = false;
  getChild("whiteprobe").visible =
    getChild("wooden_stand_open").visible =
    getChild("gauss_meter").visible =
      false;
  getChild("volt_current_switches").visible =
    getChild("volt_current_light").visible =
    getChild("wooden_stand_closed").visible =
      false;
  getChild("small_arrow_left").visible =
    getChild("small_arrow_right").visible =
    getChild("whiteprobe_connected").visible =
    getChild("whiteprobe_move").visible =
      false;
  getChild("tiny_arrow_left").visible =
    getChild("tooltip").visible =
    getChild("volt_current_light").visible =
      false;
  ...
  switch (scope.procedureModel > 0) {
    case scope.procedureModel == 1:
      ...
      getChild("gaussmeter_display").visible =
        true; /** Set the gauss meter display as true */
...
function woodenclosedExperiment(scope) {
  if (twistedwire_moveflag) {
    ...
    getChild("small_arrow_left").mouseEnabled = getChild(
      "small_arrow_right",
    ).mouseEnabled = true;
    if (!voltageFlag) {
      getChild("current_display").visible = true;
...
function calculation(scope) {
  ...
  getChild("gaussmeter_display").text = (magnetic_field * 10000).toFixed(2);
  if (voltageFlag) {
